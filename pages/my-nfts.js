    ...
    items-center flex-col min-h-screen'>
      <div className='w-full flexCenter flex-col'>
        ...
        <div className='flexCenter flex-col -mt-20 z-0'>
          <div className='flexCenter w-40 h-40
          sm:w-36 sm:h-36 p-1 bg-nft-black-2
          rounded-full'>
      ...
      {!isLoading && !nfts.length ? (
        <div className='flexCenter sm:p-4 p-16'>
          ...
          font-semibold text-3xl'>No NFTs Owned</h1>
        </div>
      ) : (
        <div className='sm:px-4 p-12 w-full minmd:w-4/5 flexCenter flex-col'>
          <div className='flex-1 w-full flex flex-row sm:flex-col ps-4 xs:px-0
          minlg:px-8'>
            SearchBar
          </div>
